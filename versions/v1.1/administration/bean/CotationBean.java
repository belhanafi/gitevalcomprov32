...
public class CotationBean {
	
	int id_cotation;
	String label_cotation;
	String definition_cotation;
	int valeur_cotation;
	...
	public int getValeur_cotation() {
		return valeur_cotation;
	}
	public void setValeur_cotation(int valeur_cotation) {
