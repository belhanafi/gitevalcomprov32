...
public class PlanningCompagneListBean {
	...
	public PlanningCompagneListBean(int id_planning_evaluation,
			...
			int id_evaluateur, int id_evalue, String code_poste,Date date_fin_evaluation,String libelle_structure) {
		super();
