...
public class SynGlobalPg1Model {
	 ...
	 * @return
	 */
	public ArrayList<DureeMoyenneBean> getDuréeMinimEvol()	{
	...
	/**
	 * cette méthode retrourne le resultat IMI par compagne
	 *  @return
	 */
	public ArrayList<IMIparVagueBean>getPerParIMI()	{
		...
		for (Entry<String, HashMap<String, Integer>> entry : listDb.entrySet()) {
			...
			for (Entry<String, Integer> pair : entry.getValue().entrySet()) {
				...
				query="select '"+vague+"' vague,"+"'Compétence à Acquérir' evaluation , round(count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+" )) taux  from "+entry.getKey()+"."+"imi_stats where imi>=0 and imi<=2 and id_compagne="+idcompagne 
						+ "  union"
						+ " select '"+vague+"' vague,"+"'Compétence à Développer' evaluation , round(count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+")) taux  from  "+entry.getKey()+"."+"imi_stats where imi>2 and imi<=3 and id_compagne="+idcompagne
						+ "	union"
						+ " select '"+vague+"' vague,"+"'Compétence Aquise' evaluation , round(count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+")) taux   from  "+entry.getKey()+"."+"imi_stats where imi>3 and imi<4.5 and id_compagne="+idcompagne
						+ " union"
	...
	public ArrayList<KpiIMIExpBean> getIMIExperience()	{
		...
		for (Entry<String, HashMap<String, Integer>> entry : listDb.entrySet()) {
			...
			for (Entry<String, Integer> pair : entry.getValue().entrySet()) {
				...
				query="select 'Compétence à acquérir' evaluation , ' Inf ou égal à 10 ans' trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence à acquérir' evaluation , ' Entre 10 et 20 ans'  trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence à acquérir' evaluation , ' Sup égal à 20 ans'  trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence à développer' evaluation , ' Inf ou égal à 10 ans' trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence à développer' evaluation , ' Entre 10 et 20 ans'  trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence à développer' evaluation , ' Sup égal à 20 ans'  trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence  acquise' evaluation , ' Inf ou égal à 10 ans' trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence  acquise' evaluation , ' Entre 10 et 20 ans'  trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
						...
						+ " union"
						+ " select 'Compétence  acquise' evaluation , ' Sup égal à 20 ans'  trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
                        ...
                        + " select 'Expertise' evaluation , ' Inf ou égal à 10 ans' trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
                        ...
                        + " union"
                        + " select 'Expertise' evaluation , ' Sup égal à 20 ans'  trancheExp,round((count(id_employe)*100/(select count(*) from "+entry.getKey()+"."+"imi_stats where id_compagne="+idcompagne+"))) taux"
	...
	/**
	 * cette méthode retrourne le taux de couverture par compagne RADAR
	 *  @return
	 */
