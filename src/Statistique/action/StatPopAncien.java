...
public class StatPopAncien extends  GenericForwardComposer{
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		Iterator it;
		List sect_items=init.getNombreEmployesAnciennte("0","0","-1",compagne_id);
	...
	private void generateChart( String code_structure,String code_poste,String code_direction ) throws SQLException {
		...
		List sect_items=init.getNombreEmployesAnciennte(code_structure,code_poste,code_direction,compagne_id);
