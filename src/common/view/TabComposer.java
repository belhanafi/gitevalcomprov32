...
public class TabComposer extends GenericForwardComposer{
	...
	public void doAfterCompose(Component comp) throws Exception 
	{
		...
		try
		{
			...
			applicationSession.setTimerValue(valeurTimer);
			...
			firstname_welcome.setValue(applicationSession.getCompteUtilisateur().getLogin()+" , "+applicationSession.getCompteUtilisateur().getNom_base());
			

			ArborescenceMenu arborescenceMenuBean=applicationSession.getArborescenceMenubean();
	...
	public void onClick$exit(MouseEvent event) throws Exception{
		...
		ApplicationSession applicationSession =(ApplicationSession) Sessions.getCurrent().getAttribute("APPLICATION_ATTRIBUTE");
		//TODO supprimer cette ligne ApplicationFacade
		applicationSession.resetArguments();		
		//TODO voir comment est til possible de détruire la session
